...
function PowerSortFilter({ onSortChange }) {
	...
	const sortOptions = [
		...
		{ value: "rarityAsc", label: "Common - Legendary" },
		{ value: "rarityDesc", label: "Legendary - Common" },
	];
	...
	return (
		<div className='relative w-full sm:w-auto'>
			<button
				...
				aria-label='Chọn thứ tự sắp xếp sức mạnh'
			>
				<span>
...
export default memo(PowerSortFilter);
