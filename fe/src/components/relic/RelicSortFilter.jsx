...
function RelicSortFilter({ onSortChange }) {
	...
	const handleSortChange = useCallback(
		value => {
			setSortOrder(value);
			saveToLocalStorage("relicsSortOrder", value);
			onSortChange(value);
			setIsOpen(false);
		},
	...
	const sortOptions = [
		...
		{ value: "rarityAsc", label: "Thường - Sử Thi" },
		{ value: "rarityDesc", label: "Sử Thi - Thường" },
	];
	...
	return (
		<div className='relative w-full sm:w-auto'>
			<button
				...
				aria-label='Chọn thứ tự sắp xếp di vật'
			>
				<span>
			...
			{isOpen && (
				<div className='absolute z-10 mt-1 w-full sm:w-48 bg-gray-800 rounded-md shadow-lg max-h-60 overflow-y-auto'>
...
export default memo(RelicSortFilter);
