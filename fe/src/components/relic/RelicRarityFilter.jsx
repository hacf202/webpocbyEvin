// RelicRarityFilter.jsx
import { memo, useState, useCallback } from "react";

function RelicRarityFilter({ uniqueRarities, onRarityChange }) {
	...
	const handleRarityChange = useCallback(
		value => {
			...
			saveToLocalStorage("relicsSelectedRarity", value);
	...
	return (
		<div className='relative w-full sm:w-auto'>
			<button
				...
				aria-label='Chọn độ hiếm của di vật'
			>
...
export default memo(RelicRarityFilter);
